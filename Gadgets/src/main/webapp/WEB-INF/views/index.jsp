...
<c:forEach items="${categoryList}" var="category">
      <li class="dropdown">
      <a class="dropdown-toggle" data-toggle="dropdown" href=${category.categoryName}>${category.categoryName}<span class="caret"></span> </a>
      <ul class="dropdown-menu">
...
<!--         <li><a href="login"><span class="glyphicon glyphicon-log-in"></span> Login</a></li> -->
		...
		<li class="divider-vertical"></li>
      		...
      		<c:if test="${pageContext.request.userPrincipal.name != 'aaa'}">
      		...
      		<c:if test="${pageContext.request.userPrincipal.name  == 'aaa'}">
       		...
       		<c:if test="${pageContext.request.userPrincipal.name  == null}">
       			...
       			<li><a  style="color:#F5F5DC;margin:0px 0px 0px 0px" href="<c:url value="/customer" />"><span class="glyphicon glyphicon-user"></span> Sign Up</a></li>
       		</c:if>
...
<footer>
            ...
            <div class="row">
                ...
                <div class="col-lg-2  col-md-2 col-sm-4 col-xs-6">
                    ...
                    <ul>
                        ...
                        <li> <a href="#"> MOBILAP Stories </a> </li>
                    </ul>
                </div>
                <div class="col-lg-2  col-md-2 col-sm-4 col-xs-6">
                    <h3> MISC </h3>
                ...
                <div class="col-lg-2  col-md-2 col-sm-4 col-xs-6">
                    ...
                    <ul>
                        ...
                        <li> <a href="#"> Sell On Mobilap </a> </li>
                        <li> <a href="#"> Report </a> </li>
                        <li> <a href="#"> Suggetions </a> </li>
                    </ul>
                </div>
                <div class="col-lg-3  col-md-3 col-sm-6 col-xs-12 ">
                    <h3> MOBILAP Subscription </h3>
                    <ul>
                        <li>
    ...
    <div class="footer-bottom">
        <div class="container">
            <p class="pull-left"> Copyright © MOBILAP E-commerce Plugin 2016. All right reserved. </p>
